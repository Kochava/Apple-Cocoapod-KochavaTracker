...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of Apple-Cocoapod-KochavaTracker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/johnbushnell/Apple-Cocoapod-KochavaTracker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'johnbushnell' => 'jbushnell@kochava.com' }
  s.source           = { :git => 'https://github.com/johnbushnell/Apple-Cocoapod-KochavaTracker.git', :tag => s.version.to_s }
